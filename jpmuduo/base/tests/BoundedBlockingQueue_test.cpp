...
class Test
{
 ...
 private:
  ...
  jpmuduo::BoundedBlockingQueue<std::string> queue_;
...
void testMove()
{
  jpmuduo::BoundedBlockingQueue<std::unique_ptr<int>> queue(10);
